...
Конструктор класса. Инициализирует объект DependencyVisualizer с конфигурационным файлом config_file. Загружает конфигурацию и устанавливает пути к визуализатору, репозиторию и выходному файлу.
Аргументы:
